...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = json.Unmarshal(corpoRequest, &usuario); erro != nil {
		fmt.Println(`erro ao converter o corpo da requisicao`)
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}

	if erro = usuario.Preparar("cadastro"); erro != nil {
		fmt.Println(`erro ao preparar o usuário`)
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
	...
	if erro != nil {
		fmt.Println(`erro ao criar o usuário`)
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
	fmt.Println("ID inserido: ", usuario.ID)
...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	segidorID, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
	}
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	if erro = repositorio.Seguir(segidorID, usuarioID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	if erro = repositorio.PararDeSeguir(segidorID, usuarioID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func BuscarSeguindo(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	usuarios, erro := repositorio.BuscarSeguido(usuarioID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {	
		respostas.Erro(w, http.StatusForbidden, errors.New("nao e possivel atualizar uma senha de um usuario que nao seja o seu"))
		return		
	}
